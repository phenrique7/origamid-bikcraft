 ...
 */
if(!window.Typekit)window.Typekit={};window.Typekit.config={"f":"//use.edgefonts.net/c/442e42/1w;lora,2,bHL:W:i4,bHN:W:i7,bHK:W:n4,bHM:W:n7/{format}{/extras*}","fi":[15726,15725,15723,15724],"fn":["lora",["i4","i7","n4","n7"]],"ht":"tk","js":"1.14.9","p":"//p.typekit.net/p.gif?s=4&h={host}&f=15726.15725.15723.15724&app={app}&_={_}","ps":4};
